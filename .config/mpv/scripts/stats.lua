...
mp.add_forced_key_binding(o.key_oneshot, "display-stats", function() process_key_binding(true) end,
    {repeatable=true})

-- Toggling key binding
mp.add_forced_key_binding(o.key_toggle, "display-stats-toggle", function() process_key_binding(false) end,
    {repeatable=false})
...
for k, _ in pairs(pages) do
    mp.add_forced_key_binding(nil, "display-page-" .. k, function() process_key_binding(true) end,
        {repeatable=true})
end
